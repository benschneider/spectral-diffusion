...
| 🟡 | Taguchi L18 DOE | Factor registry + L18 design + GitHub Actions matrix in place | Add aggregation workflow to collate 18 runs and publish report | Taguchi pipeline | Use `run_experiment.py --array configs/taguchi/L18_mixed.csv --factor-registry ...` |
