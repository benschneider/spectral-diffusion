...
| 🟡 | Documentation | README refreshed; `docs/theory.md` & `docs/architecture.md` added | Author walkthrough notebook + CONTRIBUTING guide | None | Encourage PRs by showcasing how to extend configs/samplers |
