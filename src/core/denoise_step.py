"""Utilities for diffusion denoising updates and regime selection."""
...
def select_regime(snr: Tensor, snr_clip: float) -> Dict[str, Tensor]:
    """Return boolean masks describing the diffusion regime for each sample."""
...
def describe_regime(masks: Dict[str, Tensor]) -> Tuple[str, str]:
    """Return human readable mode and loss descriptions for logging."""
